<h1 align="center">COUNTER: Cluster GCN based Energy Efficient Resource Management for Sustainable Cloud Computing Environments</h1>
...
## Cite this work
Our work is published in ICDCSW, cite using the following bibtex entry:
```bibtex
@INPROCEEDINGS{11262610,
  author={Wang, Han and Gill, Sukhpal Singh and Uhlig, Steve},
  ...
  number={},
  pages={558-563},
  doi={10.1109/ICDCSW63273.2025.00106}}
```
## License
